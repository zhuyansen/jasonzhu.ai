---
title: "OpenAI Agents SDK 大升级：把 Harness 和 Sandbox 做进 SDK，和 Anthropic 路线相反"
date: "2026-04-17"
category: "AI Agent"
tags: ["AI Agent", "OpenAI", "Anthropic", "SDK", "Harness", "开发者工具"]
excerpt: "OpenAI 给 Agents SDK 做了一次大升级，核心是把 harness 和 sandbox 做进了 SDK。Anthropic Claude Agent SDK 走的路线刚好是对立的方向——一个「帮你搭好」，一个「给你工具箱」。"
---
...
![Agent Loop 对比：传统 vs SDK 托管](public/blog/openai-agents-sdk-evolution/section1-agent-loop.png)
...
![Harness 架构演进：耦合 vs 分离](public/blog/openai-agents-sdk-evolution/section2-harness.png)
...
![Sandbox 生态：7 家提供商集成](public/blog/openai-agents-sdk-evolution/section3-sandbox.png)
...
![即将到来的能力：Subagents 和 Code Mode](public/blog/openai-agents-sdk-evolution/section4-future.png)
...
![工具集成体系](public/blog/openai-agents-sdk-evolution/section5-tools.png)
...
![OpenAI vs Anthropic 路线对比](public/blog/openai-agents-sdk-evolution/section6-vs-anthropic.png)

这两种路线没有优劣之分，适用场景不同：

- **想要深度定制、对 agent 执行过程有完全控制**的开发者，Anthropic 的路线更合适
- **想要快速上手、不想操心底层架构**的企业团队，OpenAI 的新 SDK 更省心

Python SDK 已经可用，TypeScript 支持稍后推出。定价按标准 API token 和工具使用量计费，没有额外的 harness 费用

原文：[The Next Evolution of the Agents SDK](https://openai.com/index/the-next-evolution-of-the-agents-sdk/)
