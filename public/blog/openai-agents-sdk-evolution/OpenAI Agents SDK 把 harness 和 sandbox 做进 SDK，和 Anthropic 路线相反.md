...
![Agent Loop 对比](cover-image/openai-agents-sdk-evolution/section1-agent-loop.png)
...
![Harness 架构](cover-image/openai-agents-sdk-evolution/section2-harness.png)
...
![Sandbox生态](cover-image/openai-agents-sdk-evolution/section3-sandbox.png)
...
![未来能力](cover-image/openai-agents-sdk-evolution/section4-future.png)
...
![工具集成](cover-image/openai-agents-sdk-evolution/section5-tools.png)
...
这两种路线没有优劣之分，适用场景不同。想要深度定制、对 agent 执行过程有完全控制的开发者，Anthropic 的路线更合适。想要快速上手、不想操心底层架构的企业团队，OpenAI 的新 SDK 更省心

Python SDK 已经可用，TypeScript 支持稍后推出。定价按标准 API token 和工具使用量计费，没有额外的 harness 费用

原文链接：<a href="https://openai.com/index/the-next-evolution-of-the-agents-sdk/">openai.com/index/the-next-evolution-of-the-agents-sdk/</a>

![OpenAI vs Anthropic](cover-image/openai-agents-sdk-evolution/section6-vs-anthropic.png)
